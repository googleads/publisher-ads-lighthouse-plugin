  ...
  describe('numericValue', async () => {
    const testCases = [
      ...
      },
      {
        ...
        networkRecords: [
          {initiator: {type: 'parser'}, url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js'},
          {initiator: {type: 'parser'}, url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js'},
          {initiator: {type: 'parser'}, url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js'},
        ],
        expectedScore: 1,
      },
      {
        ...
        networkRecords: [
          {initiator: {type: 'preload'}, url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js'},
          {initiator: {type: 'preload'}, url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js'},
          {initiator: {type: 'preload'}, url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js'},
        ],
        expectedScore: 1,
      ...
      },
      {
        ...
        networkRecords: [
          {initiator: {type: 'parser'}, url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js'},
          {initiator: {type: 'script'}, url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js'},
          {initiator: {type: 'preload'}, url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js'},
          {initiator: {type: 'parser'}, url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js'},
        ],
        expectedScore: 0,
