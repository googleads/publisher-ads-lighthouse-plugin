  ...
  describe('numericValue', async () => {
    const testCases = [
      ...
      },
      {
        ...
        networkRecords: [
          {initiator: {type: 'parser'}, url: 'http://securepubads.g.doubleclick.net/tag/js/gpt.js'},
          {initiator: {type: 'parser'}, url: 'http://securepubads.g.doubleclick.net/tag/js/gpt.js'},
          {initiator: {type: 'parser'}, url: 'http://securepubads.g.doubleclick.net/tag/js/gpt.js'},
        ],
        expectedScore: 1,
      },
      {
        ...
        networkRecords: [
          {initiator: {type: 'preload'}, url: 'http://securepubads.g.doubleclick.net/tag/js/gpt.js'},
          {initiator: {type: 'preload'}, url: 'http://securepubads.g.doubleclick.net/tag/js/gpt.js'},
          {initiator: {type: 'preload'}, url: 'http://securepubads.g.doubleclick.net/tag/js/gpt.js'},
        ],
        expectedScore: 1,
      ...
      },
      {
        ...
        networkRecords: [
          {initiator: {type: 'parser'}, url: 'http://securepubads.g.doubleclick.net/tag/js/gpt.js'},
          {initiator: {type: 'script'}, url: 'http://securepubads.g.doubleclick.net/tag/js/gpt.js'},
          {initiator: {type: 'preload'}, url: 'http://securepubads.g.doubleclick.net/tag/js/gpt.js'},
          {initiator: {type: 'parser'}, url: 'http://securepubads.g.doubleclick.net/tag/js/gpt.js'},
        ],
        expectedScore: 0,
