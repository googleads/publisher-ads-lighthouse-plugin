    ...
    const testCases = [
      {
        ...
        networkRecords: [
          {priority: 'Low', url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js', frameId: 'mainFrameId'},
          {priority: 'Low', url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js', frameId: 'mainFrameId'},
        ],
        expectedScore: 1,
      },
      ...
      },
      {
        ...
        networkRecords: [
          {priority: 'Low', url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js', initiator: {type: 'script'}, frameId: 'mainFrameId'},
          {priority: 'High', url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js', initiator: {type: 'script'}, frameId: 'mainFrameId'},
          {priority: 'Low', url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js', initiator: {type: 'script'}, frameId: 'mainFrameId'},
          {priority: 'Low', url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js', initiator: {type: 'script'}, frameId: 'mainFrameId'},
        ],
        expectedScore: 0,
      },
      {
        ...
        networkRecords: [
          {priority: 'High', url: 'https://securepubads.g.doubleclick.net/tag/js/gpt.js', initiator: {type: 'preload'}, frameId: 'mainFrameId'},
        ],
        expectedScore: 1,
      },
    ];
